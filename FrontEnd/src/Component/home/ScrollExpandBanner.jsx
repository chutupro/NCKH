// src/Component/home/ScrollExpandBanner.jsx
import React, { useEffect, useRef, useState } from "react";
import { motion } from "framer-motion";
import "./ScrollExpandBanner.css";

const ScrollExpandBanner = ({
  mediaType = "image",
  mediaSrc,
  posterSrc,
  bgImageSrc,
  ...
  return (
    <div ref={sectionRef} className="scroll-expand-container">
      <section className="scroll-expand-section">
        <div className="scroll-expand-wrapper">
          ...
          <div className="scroll-expand-content">
            <div className="scroll-expand-hero">
              {/* Media Container */}
              <div
              ...
              >
                {mediaType === "video" ? (
                  ...
                  <div className="scroll-expand-image-wrapper">
                    ...
                    />
                    <motion.div
                      className="scroll-expand-image-overlay"
                      initial={{ opacity: 0.7 }}
                ...
                <div className="scroll-expand-hints">
                  {subtitle && (
                    <p
                      className="scroll-expand-subtitle"
...
export default ScrollExpandBanner;
