    ...
    <div className="container-explo">
      ...
      <div className="container-inf">
        <div className="content-inf content-inf--feature">
          ...
          <div className="media">
            <img src="https://danangfantasticity.com/wp-content/uploads/2022/02/BA-NA-MO-CUA.jpg" alt="feature" />
          </div>
        </div>
        ...
        <div className="content-inf">
          ...
          <div className="media">
            <img src="https://danangfantasticity.com/wp-content/uploads/2022/02/BA-NA-MO-CUA.jpg" alt="new" />
          </div>
        </div>
        ...
        <div className="content-inf">
          ...
          <div className="media">
            <img src="https://danangfantasticity.com/wp-content/uploads/2022/02/BA-NA-MO-CUA.jpg" alt="category" />
          </div>
        </div>
      </div>
    </div>
